...
**Location App** is an Android mobile application built using Kotlin and Jetpack Compose. This is a simple location app using Android GMS location to learn its concepts.
...
1. Clone the repository:
    ```sh
    git clone https://github.com/msvalandro/LocationApp.git
    cd LocationApp
    ```
